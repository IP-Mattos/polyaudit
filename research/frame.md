...
`0xf418...` audit, three pair-audits, and an 8-wallet batch on Aug 1
...
README's "nine" meant the 8-wallet batch plus the earlier solo `0xf418...`
...
rebate-dependent cases are named individually** (`0xf418...` at its Aug-3
cutoff, 0x0484..., 0xce25..., 0x0cb038...), each with its own
...
|---|--------|-------------|--------|
| 1 | 0xf418... | +$99-101k profile, promoted publicly | reconciled |
| 2 | 0x0484... | +$214.8k profile | reconciled |
| 3 | 0xce25... | +$533k lifetime | reconciled |
| 4 | Impressive-Steak (0x06dc...) | +$495k profile | reconciled |
| 5 | 0x32ed... | +$198k profile | reconciled |
...
|---|--------|-------------|---------------|-----|--------|
| 19 | `0xf418...` re-run | (same wallet as #1, fresh window) | 234,911 | 2.2% | reconciled |
...
**Style alone does not censor either**: `0xf418...` is redemption-heavy
